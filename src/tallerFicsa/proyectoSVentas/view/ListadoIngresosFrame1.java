 ...
 * @author Usuario
 */
public class ListadoIngresosFrame1 extends javax.swing.JInternalFrame {

    private DefaultTableModel model;
    private IngresoJpaController ingobj = new IngresoJpaController();
...
//        JButton btn = new JButton("...");
        ...
        try {
            listaIngresos = ingobj.listarIngresos();
            for (int i = 0; i < listaIngresos.size(); i++) {
                ingreso = (Ingreso) listaIngresos.get(i);
                obj[0] = ingreso.getIdingreso();
                obj[1] = ingreso.getSerieComprobante();
                obj[2] = ingreso.getNumComprobante();
                obj[3] = ingreso.getTipoComprobante();
                obj[4] = ingreso.getIdproveedor().getNombre();
                obj[5] = ingreso.getIdusuario().getNombre();
                obj[6] = ingreso.getTotalCompra();
...
//                obj[9]= btn;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("LISTADO DE INGRESO DE PRODUCTOS");
        ...
        if (tblDatos.getSelectedRowCount() == 1) {
            try {
                ...
                if (JOptionPane.showConfirmDialog(null, "Quieres ver el detalle de este ingreso ?") == JOptionPane.YES_OPTION) {
                        ListaDetalleIngresoFrame ldif = new ListaDetalleIngresoFrame(idIngreso);
